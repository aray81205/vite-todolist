...
function TodoList() {
  ...
  async function removeTodo(item) {
    await axios
      .delete(`${VITE_APP_HOST}/todos/${item.id}`, {
  ...
  async function updateStatus(e, item) {
    ...
    await axios
      .patch(
        `${VITE_APP_HOST}/todos/${item.id}/toggle`,
        {},
        { headers: { Authorization: token } }
      )
      .then((response) => {})
          ...
          <div className="todoList_list">
            <ul className="todoList_tab">
              <li>
                <button
                  type="button"
                  onClick={() => changeTodoStatus("all")}
                  className={todoStatus === "all" ? "active" : ""}
                >
                  全部
                </button>
              </li>
              <li>
                <button
                  type="button"
                  onClick={() => changeTodoStatus("inCompleted")}
                  className={todoStatus === "inCompleted" ? "active" : ""}
                >
                  待完成
                </button>
              </li>
              <li>
                <button
                  type="button"
                  onClick={() => changeTodoStatus("completed")}
                  className={todoStatus === "completed" ? "active" : ""}
                >
                  已完成
                </button>
              </li>
            ...
            <div className="todoList_items">
              ...
              <div className="todoList_statistics">
                ...
                <button type="button" onClick={() => removeTodoList()}>
                  清除已完成項目
                </button>
              </div>
            </div>
